...
<Navbar let:hidden let:toggle color="none" navClass="bg-black px-2 sm:px-4 py-2.5 w-full">
	...
	>
		...
		<NavLi href="/contact" active={true}>Kontakt</NavLi>
	</NavUl>
</Navbar>
<div
...
>
	...
	<div class="space-y-6">
		<div class="flex flex-row items-center space-x-3 h-20 px-9 md:px-32 lg:px-56">
			<img src={qr} alt="Kod QR" class="w-18" />
		</div>
	</div>
